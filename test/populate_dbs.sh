...
python3 generate_synthetic_docs.py -s ../docs/general_doc_schema.json -n 10 -m CT -l logs/
python3 generate_synthetic_docs.py -s ../docs/general_doc_schema.json -n 8 -m MR -l logs/
python3 generate_synthetic_docs.py -s ../docs/general_doc_schema.json -n 6 -m US -l logs/
python3 generate_synthetic_docs.py -s ../docs/general_doc_schema.json -n 4 -m PR -l logs/
python3 generate_synthetic_docs.py -s ../docs/general_doc_schema.json -n 2 -m "*" -l logs/
